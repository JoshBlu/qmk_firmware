...
||||||| parent of 5d6f2f6156 (defined TAPPING_TOGGLE, undefined all RGB effects except for solid color to save space)
=======
...
#undef ENABLE_RGB_MATRIX_PIXEL_RAIN          // Randomly light keys with random hues
    ...
    #undef ENABLE_RGB_MATRIX_SOLID_MULTISPLASH   // Hue & value pulse away from multiple key hits then fades value out
#endif
>>>>>>> 5d6f2f6156 (defined TAPPING_TOGGLE, undefined all RGB effects except for solid color to save space)
